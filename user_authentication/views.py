...
from main.api_weather import make_request_query_set, make_request_name, \
    make_request_lat_long,detect_location, make_request_hourly_city_id
from django.core.mail import send_mail
from main.models import Image_Theme
...
def profile_home(request):
    ...
    if hometown == '' or city_list == '':
        ...
        img_query_set = Image_Theme.objects.filter(image_theme_id=hometown['set']['weather'][0]['icon'])
        img = ''
